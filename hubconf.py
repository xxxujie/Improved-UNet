import torch
from my_unet import UNet as _UNet
...
def unet_carvana(pretrained=False, scale=0.5):
    ...
    if pretrained:
        if scale == 0.5:
            checkpoint = (
                "https://github.com/milesial/Pytorch-UNet/releases/download/"
                "v3.0/unet_carvana_scale0.5_epoch2.pth"
            )
        elif scale == 1.0:
            checkpoint = (
                "https://github.com/milesial/Pytorch-UNet/releases/download/"
                "v3.0/unet_carvana_scale1.0_epoch2.pth"
            )
        else:
